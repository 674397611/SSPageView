...
@objc protocol SSContentViewDelegate : class {
    func contentView(_ contentView : SSContentView, progress : CGFloat, sourceIndex : Int, targetIndex : Int)
    
    @objc optional func contentViewEndScroll(_ contentView : SSContentView)
}

private let kContentCellID = "kContentCellID"

class SSContentView: UIView {
    
    // MARK: 对外属性
    weak var delegate : SSContentViewDelegate?
...
extension SSContentView : UICollectionViewDataSource {
...
extension SSContentView : UICollectionViewDelegate {

...
// MARK:- 定义协议
protocol SSTitleViewDelegate : class {
    func titleView(_ titleView : SSTitleView, selectedIndex index : Int)
}

class SSTitleView: UIView {
    
    // MARK: 对外属性
    weak var delegate : SSTitleViewDelegate?
    ...
    // MARK: 自定义构造函数
    init(frame: CGRect, titles : [String], style : SSTitleStyle) {
